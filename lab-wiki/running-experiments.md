...
```{warning} Prior to conducting the experiment: 
Ask the participant to read through and sign the consent form. Record (1) Age, (2) Sex, (3) Hand dominance.
```

Write subject ID on the top right-hand corner of the consent form.
 
***Note**: There should be plenty of consent forms printed out and at least $50 cash in the lab's file cabinets. Let the lab manager know if we are running low on either consent forms or petty cash. Also, remember to keep an up-to-date copy of the consent form in your projects directory so that you can also print out a copy if need be.*
...
5. Once task is complete, follow our [Data Management](/lab-wiki/data-management) page to understand how/where data is stored, how to log onto dropbox, and how to record completion in the participant_key.xlsx.
...
- Follow our [Data Management](/lab-wiki/data-management) page to understand how/where data is stored, how to log onto dropbox, and how to record completion in the participant_key.xlsx.
