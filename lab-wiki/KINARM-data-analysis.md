...
- Running the script will produce a CSV of their trial-by-trial data per participant. These should be kept local and are not stored on Dropbox (see [Data Management](https://ccmlab-ubc.github.io/lab-manual/data-management) for more information)
