...
**Tip:** You should add any directories containing raw data.  For example, you may want to have a sub-directory "raw" under data where you keep the raw data files. You don't want git to track those files since they can be cumbersome and they should never change. So, the best thing to do would be to add ```**/raw``` to the .gitignore file. 

We store raw data on hard drive of testing computer, in the cloud, and backed-up on your own personal computer.  
